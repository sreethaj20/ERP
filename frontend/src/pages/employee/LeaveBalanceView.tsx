      ...
      {loading ? (
        ...
        <div className="grid-3">
          <GlassCard title="Casual/Earned Leave" subtitle="Annual Balance">
            <h2 style={balanceStyle}>{formatDays(parseFloat(balances.casual_leave || 0) + parseFloat(balances.earned_leave || 0))} Days Left</h2>
          </GlassCard>
  
          <GlassCard title="Sick Leave" subtitle="Annual Balance">
            <h2 style={balanceStyle}>{formatDays(balances.sick_leave)} Days Left</h2>
          </GlassCard>
          ...
          <GlassCard title="Used Leaves" subtitle="Year to date">
            <h2 style={{ ...balanceStyle, color: '#ff9f0a' }}>{formatDays(balances.total_used)} Days</h2>
          </GlassCard>
  
          <GlassCard title="Carried Forward" subtitle="Unused from Previous Month">
            <h2 style={{ ...balanceStyle, color: '#30d158' }}>
              {formatDays(balances.carry_forward_days || balances.carry_forward)} Days
            </h2>
          </GlassCard>
