...
class PDFService:
    ...
    async def generate_offer_letter(self, data: dict) -> str:
        ...
        text = (
            ...
            f"at Mercure. We were impressed with your skills and experience and believe "
        ...
        hr_sig_data = [
            ...
            [""], # Spacer
            [Paragraph("<b>HR Management Team</b><br/>Mercure Portal", body_style)]
        ]
    ...
    async def generate_relieving_letter(self, data: dict) -> str:
        ...
        text = (
            ...
            f"was employed with Mercure from <b>{data.get('joining_date', 'N/A')}</b> to <b>{data.get('exit_date', 'N/A')}</b>. "
        ...
        story.append(Paragraph("For Mercure,", body_style))
        story.append(Spacer(1, 0.1 * inch))
